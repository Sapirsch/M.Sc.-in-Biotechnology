% This code calculates the mutation proportion of each replicate of the evolved DmutS strain

load('mutations')

col_1.muts = mutations.col1;
col_2.muts = mutations.col2;
col_3.muts = mutations.col3;
col_4.muts = mutations.col4;
col_5.muts = mutations.col5;
col_6.muts = mutations.col6;
col_7.muts = mutations.col7;
col_8.muts = mutations.col8;
col_9.muts = mutations.col9;
col_10.muts = mutations.col10;
